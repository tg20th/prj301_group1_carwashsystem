...
<head>
    ...
    <title>Fleet Invoice History | Elite Auto</title>
    ...
    <style>
        .bus-filter-btn.active { background: #212529 !important; color: #fff !important; }
        .invoice-row { transition: background-color 0.2s ease; cursor: pointer; }
        .invoice-row:hover { background-color: #f8f9fa; }
    </style>
</head>
<body class="bus-page invoice-history-compact">
    <%@ include file="includes/business_nav.jsp" %>

    <div class="container py-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4">
            <div>
                <h2 class="fw-bold mb-1">Fleet Invoice History</h2>
                <p class="text-muted small mb-0">Track fleet invoices, discounts, and booking batches.</p>
            </div>
                ...
                <table class="table align-middle table-hover mb-0 bus-table">
                    ...
                    <tbody>
                        ...
                        <tr class="invoice-row" data-status="<%= status %>"
                            ...
                            <td>
                                <div class="fw-semibold text-dark"><%= inv.getServiceSummary() != null ? inv.getServiceSummary() : "Fleet booking" %></div>
                                <div class="text-muted small"><%= inv.getBookingCount() %> vehicle<%= inv.getBookingCount() == 1 ? "" : "s" %></div>
                            </td>
                            <td>
