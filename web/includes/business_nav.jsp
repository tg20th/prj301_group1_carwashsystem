...
<nav class="navbar navbar-expand-lg py-3 bg-white sticky-top shadow-sm border-bottom">
    <div class="container">
        <a class="navbar-brand fw-bold tracking-tight text-decoration-none text-dark" href="MainController?action=business_dashboard">
        ...
        <div class="collapse navbar-collapse" id="busNavbar">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-1 gap-lg-2">
                <li class="nav-item">
                    <a href="MainController?action=business_dashboard"
                       class="nav-link rounded-pill px-3 small bus-nav-link <%= "dashboard".equals(navActive) ? "active" : "" %>">
                        <i class="bi bi-grid me-1"></i>Dashboard
                    </a>
                </li>
                <li class="nav-item">
                    <a href="MainController?action=business_booking"
                ...
                <li class="nav-item">
                    <a href="MainController?action=viewbusinesshistory"
