...
public class BusinessBookingController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (op != null && !op.isEmpty()) {
            ...
            if (mainAction == null || mainAction.isEmpty() || "business_booking".equals(mainAction)) {
                action = "page";
            } else {
                action = mainAction;
            }
    ...
    private void handleSubmit(HttpServletRequest request, HttpServletResponse response, Customer customer)
        ...
        try {
            ...
            if (result != null) {
                response.sendRedirect("MainController?action=business_payment&invoiceId=" + result.getInvoiceId());
                return;
            }
