...
@WebServlet(name = "ManageInvoiceController", urlPatterns = {"/ManageInvoiceController"})
public class ManageInvoiceController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("invoice_viewdetails.jsp").forward(request, response);
    }
