...
@WebServlet(name = "DeleteTimeSlotController", urlPatterns = {"/DeleteTimeSlotController"})
public class DeleteTimeSlotController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        sendResponse(request, response, isAjax, false,
                "Time slots are fixed and cannot be deleted individually. Use Regenerate if needed.",
                slotDate);
    }
